...
export const projects = defineType({
  ...
  fieldsets: [
    ...
    },
    {
      name: 'seo',
      title: 'SEO / Meta Tags',
      description: 'Customize how this project appears in search engine results',
      options: { collapsible: true, collapsed: true }
    }
  ],
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      fieldset: 'seo',
      description: 'Custom title for search engines and browser tabs. Recommended: 50-60 characters. Leave empty to auto-generate from project title.',
    ...
    defineField({
      ...
      rows: 3,
      fieldset: 'seo',
      description: 'Brief summary for search engine results. Recommended: 150-160 characters. Leave empty to auto-generate from project description.',
