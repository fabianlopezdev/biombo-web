export const projectsTranslations = {
  ca: {
    ...
    screenReaderAnnouncements: {
      filtersActive: (count: number, visible: number) => `${count} filtres actius. Mostrant ${visible} projectes.`,
  ...
  es: {
    ...
    screenReaderAnnouncements: {
      filtersActive: (count: number, visible: number) => `${count} filtros activos. Mostrando ${visible} proyectos.`,
  ...
  en: {
    ...
    screenReaderAnnouncements: {
      filtersActive: (count: number, visible: number) => `${count} active filters. Showing ${visible} projects.`,
